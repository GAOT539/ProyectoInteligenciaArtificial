...
model_path = os.path.abspath(os.path.join("..", "LenguajeSeñas", "Code", "modelo_2209_miguel.h5"))
...
#    
    ...
    ##Modificar en caso de cambiar la ubicacion desde la que se ejecuta '\ProyectoInteligenciaArtificial\InterfazGUI> py .\Inicio.py'
    lista = os.listdir(os.path.abspath(os.path.join("..", "LenguajeSeñas", "Code", "Signos ASL")))
#    while(True):
#        for i in range(24):
#            print(type(lista[i]))
