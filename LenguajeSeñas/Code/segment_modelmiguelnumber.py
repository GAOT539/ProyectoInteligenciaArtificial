...
#model_path = "./Code/modelmiguelnumber.h5"
##Modificar en caso de cambiar la ubicacion desde la que se ejecuta '\ProyectoInteligenciaArtificial\InterfazGUI> py .\Inicio.py'
model_path = os.path.abspath(os.path.join("..", "LenguajeSeñas", "Code", "modelmiguelnumber.h5"))
...
if __name__ == "__main__":
    ...
    #lista=os.listdir('./Code/Signos Numeros')
    ##Modificar en caso de cambiar la ubicacion desde la que se ejecuta '\ProyectoInteligenciaArtificial\InterfazGUI> py .\Inicio.py'
    lista = os.listdir(os.path.abspath(os.path.join("..", "LenguajeSeñas", "Code", "Signos Numeros")))
...
#        Las de abajo
        ...
        cv2.imshow("Video Numeros", clone)
...
#            cv2.putText(cloneletrica, letrica, (left-100, top+50), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255,255,255), 2)
        ...
        # if the user pressed "q", then stop loopingq
